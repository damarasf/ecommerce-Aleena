                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
												<a href="{{route('product-detail',$data->slug)}}" title="Product Detail"><i class=" ti-eye"></i><span>Product Detail</span></a>
                                            ...
                                            <div class="product-action-2">
                                                <a data-toggle="modal" data-target="#{{$data->id}}" title="Add to cart" href="{{route('add-to-cart',$data->slug)}}">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
